...
template<class Derived> void Gadgetron::ImageArraySendMixin<Derived>::prep_image_header_send_out(mrd::ImageArray& res, size_t n, size_t s, size_t slc, size_t encoding, int series_num, const std::string& data_role) const
{
        ...
        auto& header = res.headers(slc, s, n);
        auto& meta = res.meta(slc, s, n);
        ...
        if (data_role == GADGETRON_IMAGE_REGULAR)
        {
            ...
            // res.meta(slc, s, n).append(GADGETRON_IMAGECOMMENT, "GT");
            meta[GADGETRON_IMAGECOMMENT].push_back("GT");

            // res.meta(slc, s, n).append(GADGETRON_SEQUENCEDESCRIPTION, "_GT");
            meta[GADGETRON_SEQUENCEDESCRIPTION].push_back("_GT");
            // res.meta(slc, s, n).set(GADGETRON_DATA_ROLE, GADGETRON_IMAGE_REGULAR);
        ...
        else if (data_role == GADGETRON_IMAGE_GFACTOR)
        {
            ...
            // res.meta(slc, s, n).append(GADGETRON_IMAGECOMMENT, GADGETRON_IMAGE_GFACTOR);
            // res.meta(slc, s, n).append(GADGETRON_SEQUENCEDESCRIPTION, GADGETRON_IMAGE_GFACTOR);
            // res.meta(slc, s, n).set(GADGETRON_DATA_ROLE, GADGETRON_IMAGE_GFACTOR);
            ...
            // res.meta(slc, s, n).set(GADGETRON_SKIP_PROCESSING_AFTER_RECON, (long)1);
        ...
        else if (data_role == GADGETRON_IMAGE_SNR_MAP)
        {
            ...
            // res.meta(slc, s, n).append(GADGETRON_IMAGECOMMENT, GADGETRON_IMAGE_SNR_MAP);
            // res.meta(slc, s, n).append(GADGETRON_SEQUENCEDESCRIPTION, GADGETRON_IMAGE_SNR_MAP);
            // res.meta(slc, s, n).set(GADGETRON_DATA_ROLE, GADGETRON_IMAGE_SNR_MAP);
        ...
        else if (data_role == GADGETRON_IMAGE_RETRO)
        {
            ...
            // res.meta(slc, s, n).append(GADGETRON_IMAGECOMMENT, "RETRO");
            // res.meta(slc, s, n).append(GADGETRON_SEQUENCEDESCRIPTION, "RETRO");
            // res.meta(slc, s, n).set(GADGETRON_DATA_ROLE, GADGETRON_IMAGE_RETRO);
